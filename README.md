...
# Conclusion </br>
* Are longer movies more popular? The runtime of a movie not effect its popularity entirely. Audiences take into account whether or not a movie is worth their time. Screendaily mentions that films that tells a story in an engaging way will be more popular and result in higher box office earning. This can be seen from Avengers: Endgame with a long runtime of 180 minutes, yet earned $2.8 billion at the global box office with an IMBD rating of 8.4/10.
