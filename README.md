...
text here, how to interact with the bubble chart movie revenue runtime popularity
...
text here about popularity, runtime, movie revenue with the linear regression
